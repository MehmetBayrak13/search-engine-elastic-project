...
export function searchProducts({ query, page, enablePhrase, enableMultiMatch, enableFuzzy, enableExactAsin, enablePriceExtraction, sort }) {
  return request('/api/search', {
    ...
    enable_price_extraction: enablePriceExtraction,
    sort,
